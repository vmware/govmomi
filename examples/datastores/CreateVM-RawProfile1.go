...
func main() {
	...
	// new code
	dummyVMName := "MARVEL-checkyou-prashanth1"
			...
			&types.VirtualDeviceConfigSpec{
				...
				Profile: []types.BaseVirtualMachineProfileSpec{
					&types.VirtualMachineDefinedProfileSpec{
						// ProfileId: "20029732-8ae8-4aa1-8fd0-429d8f91ceae",
						ProfileId: "",
						ProfileData: &types.VirtualMachineProfileRawData{
							ExtensionKey: "com.vmware.vim.sps",
							// ObjectData:   "((\"readOPS\" (i99 i1001)))",
							ObjectData: "((\"stripeWidth\" i2) (\"hostFailuresToTolerate\" i0))",
						},
					},
				},
			},
