...
func main() {
	...
	vmDiskPath := "[vsanDatastore] kubevols/nayo.vmdk"
	...
	// new code
	dummyVMName := "MARVEL-balu-123"
	vmDatastorePath := "[" + datastorePathObj.Datastore + "] " + dummyVMName
	fileInfoVM := &types.VirtualMachineFileInfo{
		VmPathName: vmDatastorePath,
	}
	...
	*disk.UnitNumber = unitNumber
	...
	storageProfileSpec := &types.VirtualMachineDefinedProfileSpec{
		...
		ProfileData: &types.VirtualMachineProfileRawData{
			...
			ObjectData:   "((\"hostFailuresToTolerate\" i0))",
		},
	}
