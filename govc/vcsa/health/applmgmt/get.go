...
func init() {
	cli.Register("vcsa.health.applmgmt.get", &get{})
}
...
func (cmd *get) Description() string {
	return `Get health status of applmgmt services.
Examples:
  govc vcsa.health.applmgmt.get`
}

type applmgmtHealth struct {
...
func (cmd *get) Run(ctx context.Context, f *flag.FlagSet) error {
	...
	return cmd.WriteResult(&applmgmtHealth{Value: status})
}

func (res applmgmtHealth) Write(w io.Writer) error {
