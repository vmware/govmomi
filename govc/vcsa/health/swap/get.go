...
func init() {
	cli.Register("vcsa.health.swap.get", &get{})
}
...
func (cmd *get) Description() string {
	return `Get swap health.
Examples:
  govc vcsa.health.swap.get`
}

type swapHealth struct {
...
func (cmd *get) Run(ctx context.Context, f *flag.FlagSet) error {
	...
	return cmd.WriteResult(&swapHealth{Value: status})
}

func (res swapHealth) Write(w io.Writer) error {
