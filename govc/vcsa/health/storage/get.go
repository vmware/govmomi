...
func init() {
	cli.Register("vcsa.health.storage.get", &get{})
}
...
func (cmd *get) Run(ctx context.Context, f *flag.FlagSet) error {
	...
	return cmd.WriteResult(&storageHealth{Value: status})
}

func (res storageHealth) Write(w io.Writer) error {
