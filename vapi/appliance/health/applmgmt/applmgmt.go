...
const HealthPath = "/appliance/health/applmgmt"

// Manager provides convenience methods to get health status of applmgmt services.
type Manager struct {
	*rest.Client
}
...
//Get gets health status of applmgmt services.
