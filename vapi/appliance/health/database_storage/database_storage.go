...
const HealthPath = "/appliance/health/database-storage"

// Manager provides convenience methods to retrieve the health of database storage.
type Manager struct {
	*rest.Client
}
...
// Get returns database storage health.
