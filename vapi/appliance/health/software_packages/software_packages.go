...
const HealthPath = "/appliance/health/software-packages"

// Manager provides convenience methods to get information on available software
// updates available in remote VUM repository.
type Manager struct {
	*rest.Client
}
...
// Get gets information on available software updates available in the remote vSphere Update Manager repository.
