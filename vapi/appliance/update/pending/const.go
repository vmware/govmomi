...
const (
	// CRITICAL represents Vulnerabilities that can be exploited by an unauthenticated attacker
	// from the Internet or those that break the guest/host Operating System isolation.
	CRITICAL Severity = "CRITICAL"

	// IMPORTANT represents Vulnerabilities that are not rated critical but whose exploitation
	...
	// MODERATE represents Vulnerabilities where the ability to exploit is mitigated to a
	...
	// LOW_SEVERITY represents All other issues that have a security impact. Vulnerabilities
...
//SourceType defines the supported types of sources of updates.
const (
	...
	// LOCAL_AND_ONLINE Check the local sources, ISO devices, staged area,
	// then online repository as stated in update policy
