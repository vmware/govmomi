...
// RelocateVolume calls the CNS RelocateVolume API.
func (c *Client) RelocateVolume(ctx context.Context, relocateSpecList []cnstypes.CnsVolumeRelocateSpec) (*object.Task, error) {
	req := cnstypes.CnsRelocateVolume{
		This:          CnsVolumeManagerInstance,
		RelocateSpecs: relocateSpecList,
	}
